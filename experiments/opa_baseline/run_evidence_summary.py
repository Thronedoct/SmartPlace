...
def build_change_rows() -> list[dict[str, str]]:
    return [
        ...
        change_row(
            "C009",
            "Web demo workflow and visual polish",
            "frontend workflow",
            "Load stable demo cases, export recommendation evidence, surface confidence prompts, and switch to a classroom demo layout.",
            "web/app.js; web/index.html; web/styles.css; server/app.py; docs/API.md",
            "Web UI validation V016/V017; /api/demo/cases; exported JSON/CSV; presentation mode",
            "completed",
            "Makes the app easier to demo, improves scanability, and reduces live-presentation risk.",
            "Current validation used Playwright fallback because the in-app Browser runtime failed to start.",
            "Keep future UI work focused on evidence handoff rather than decorative redesign.",
        ),
        change_row(
            "C010",
